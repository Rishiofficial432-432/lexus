...
interface HyperspeedOptions {
  ...
  // FIX: Changed tuple types to `readonly` to match `hyperspeedPresets` which is declared `as const`.
...
// FIX: Changed parameter `base` type from `[number, number]` to `readonly [number, number]` to allow readonly tuples.
...
class CarLights {
  ...
  // FIX: Changed property and constructor parameter `speed` type to `readonly [number, number]`.
