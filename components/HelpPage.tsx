  ...
  return (
    <div className="space-y-8">
      ...
      <Section title="1. The Core Philosophy: Your Data, Your Device">
        <p>
          Before diving into the features, it's essential to understand what makes LEXUS different. It is a <strong>local-first</strong> and <strong>privacy-first</strong> application.
        </p>
      ...
      <Section title="2. The Minimum Viable Product (MVP) - The Core of LEXUS">
        <p>The core value proposition of LEXUS is to provide a <strong>private, unified space to capture, organize, and act on your thoughts.</strong> The MVP focuses on delivering this value in the most direct way possible, establishing the foundation upon which all other features are built.</p>
      ...
      <Section title="3. The Full LEXUS Experience - A Comprehensive Tour">
        <p>The current version of LEXUS has evolved far beyond the MVP, integrating over 15 distinct features into a cohesive whole.</p>
        ...
        <ol className="list-decimal pl-6 space-y-2 mt-4">
          <li><strong>The Left Sidebar (Navigation):</strong> This is how you move between the major sections of the app: the <strong>Dashboard</strong>, <strong>Academics Hub</strong>, <strong>Notes</strong>, <strong>Journal</strong>, and <strong>VisualMind</strong>, among others.</li>
        ...
        <h3 className="text-2xl font-bold text-white mt-8 mb-4">Module 4: VisualMind - Your Visual Explorer</h3>
        ...
        <p>Securely connect your Google account to search your Google Drive from within LEXUS. A single click imports a Google Doc or Sheet as a new, fully-formatted note.</p>
      ...
      <Section title="4. Conclusion: The LEXUS Philosophy in Practice">
        <p>LEXUS brings together over a dozen powerful tools into a single, cohesive application. By starting with a core of capturing and organizing thoughts, and then layering on intelligent, action-oriented features, it creates a workspace that is both powerful and deeply personal. Its unwavering commitment to local-first data ensures that this powerful space is also completely private and secure.</p>
      </Section>
    </div>
  );
};